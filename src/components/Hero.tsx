      ...
      <div className="relative z-20 max-w-7xl w-full px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            <div className="mb-8">
              <div className="inline-flex items-center bg-yellow-500/20 border border-yellow-500/30 rounded-full px-4 py-2 mb-4 sm:mb-6">
          ...
          <div className="text-center lg:text-right">
            <div className="mb-6 sm:mb-8">
              <img 
                ...
                className="h-32 sm:h-48 w-auto mx-auto lg:ml-auto animate-pulse"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={idx}
                  className="bg-black/60 backdrop-blur-sm border border-yellow-500/20 rounded-lg p-5 sm:p-6 hover:border-yellow-500/40 transition-all duration-300"
                >
                  <Icon className="h-6 sm:h-8 w-6 sm:w-8 text-yellow-400 mx-auto mb-2" />
                  <h3 className="text-white font-semibold sm:font-bold mb-1 sm:mb-2 uppercase tracking-wide text-sm sm:text-base">{title}</h3>
